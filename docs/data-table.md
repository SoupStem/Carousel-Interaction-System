## **Integrating the Inventory Data Table**
...
2. **Select Row Type:** In the prompt, locate and select the required row structure: ***InventoryList***
3. **Rename:** Rename the new asset clearly (e.g., ***DT_InventoryList***).
...
**Step 3: Setting the Data Table in Plugin Settings**
...
4. **Set Value:** Assign the **Data Table** you just created (***DT_InventoryList*** or equivalent) to this field.
